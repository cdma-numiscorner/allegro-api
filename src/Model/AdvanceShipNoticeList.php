...
class AdvanceShipNoticeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'advance_ship_notices' => '\AllegroApi\Model\AdvanceShipNoticeResponse[]',
        'count' => 'float',
        'total_count' => 'float'
    ];
    ...
    {
        $this->setIfExists('advance_ship_notices', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['advance_ship_notices'] === null) {
            $invalidProperties[] = "'advance_ship_notices' can't be null";
        }
     ...
     *
     * @param \AllegroApi\Model\AdvanceShipNoticeResponse[] $advance_ship_notices advance_ship_notices
     *
     * @return self
     */
    public function setAdvanceShipNotices($advance_ship_notices)
    {
        if (is_null($advance_ship_notices)) {
            throw new \InvalidArgumentException('non-nullable advance_ship_notices cannot be null');
        }
     ...
     * Sets count
     *
     * @param float $count A number of Advance Ship Notices in response.
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param float $total_count A number of Advance Ship Notices in total.
     *
     * @return self
     */
