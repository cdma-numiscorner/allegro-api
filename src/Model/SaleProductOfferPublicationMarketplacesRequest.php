...
/**
 * SaleProductOfferPublicationMarketplacesRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SaleProductOfferPublicationMarketplacesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleProductOfferPublicationMarketplacesRequest';
     ...
     * Sets additional
     *
     * @param \AllegroApi\Model\JustId[]|null $additional Specifies whether an offer should be visible in the additional marketplace. This field is not mandatory. We will interpret the absence of this field as an empty array (the listing will be visible only in its base marketplace).
     *
     * @return self
     */
