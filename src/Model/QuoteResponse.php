...
class QuoteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cycle_duration', $data ?? [], null);
        $this->setIfExists('classifieds_package', $data ?? [], null);
    }
    ...
    */
    ...
    public function setCycleDuration($cycle_duration)
    {
        if (is_null($cycle_duration)) {
            throw new \InvalidArgumentException('non-nullable cycle_duration cannot be null');
        }
    ...
    {
        if (is_null($classifieds_package)) {
            throw new \InvalidArgumentException('non-nullable classifieds_package cannot be null');
        }
