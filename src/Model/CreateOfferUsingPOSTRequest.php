...
/**
 * CreateOfferUsingPOSTRequest Class Doc Comment
 *
 * @category Class
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateOfferUsingPOSTRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createOfferUsingPOST_request';
    ...
    protected static $openAPITypes = [
        'category' => '\AllegroApi\Model\CreateOfferUsingPOSTRequestAllOfCategory',
    ...
    */
     ...
     * Gets category
     *
     * @return \AllegroApi\Model\CreateOfferUsingPOSTRequestAllOfCategory|null
     */
     ...
     * Sets category
     *
     * @param \AllegroApi\Model\CreateOfferUsingPOSTRequestAllOfCategory|null $category category
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateOfferUsingPOSTRequest., must be smaller than or equal to 50.');
        }
