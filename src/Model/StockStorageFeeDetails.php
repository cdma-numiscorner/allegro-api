 ...
 */
class StockStorageFeeDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockStorageFee_details';
    ...
    {
        $this->setIfExists('charged_items_quantity', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $charged_items_quantity Number of items, for which storage fee was charged. For example seller might have 20 items in total, but only 3 of them are stored longer than free storage period, so the fee is applied only for them.
     *
     * @return self
     */
    public function setChargedItemsQuantity($charged_items_quantity)
    {
        if (is_null($charged_items_quantity)) {
            throw new \InvalidArgumentException('non-nullable charged_items_quantity cannot be null');
        }
     ...
     * Sets amount_gross
     *
     * @param float|null $amount_gross Total gross amount of the charged fee.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Currency in which the fee was charged.
     *
     * @return self
     */
