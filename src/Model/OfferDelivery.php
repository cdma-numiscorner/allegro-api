...
class OfferDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('available_for_free', $data ?? [], null);
        $this->setIfExists('lowest_price', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($available_for_free)) {
            throw new \InvalidArgumentException('non-nullable available_for_free cannot be null');
        }
    ...
    public function setLowestPrice($lowest_price)
    {
        if (is_null($lowest_price)) {
            throw new \InvalidArgumentException('non-nullable lowest_price cannot be null');
        }
