...
class Thread implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'interlocutor' => '\AllegroApi\Model\Interlocutor'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('last_message_date_time', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($last_message_date_time)) {
            array_push($this->openAPINullablesSetToNull, 'last_message_date_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_message_date_time', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets interlocutor
     *
     * @return \AllegroApi\Model\Interlocutor|null
     */
     ...
     * Sets interlocutor
     *
     * @param \AllegroApi\Model\Interlocutor|null $interlocutor interlocutor
     *
     * @return self
     */
    public function setInterlocutor($interlocutor)
    {
        if (is_null($interlocutor)) {
            array_push($this->openAPINullablesSetToNull, 'interlocutor');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('interlocutor', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
