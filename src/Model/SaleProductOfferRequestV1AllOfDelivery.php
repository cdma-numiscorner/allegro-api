...
/**
 * SaleProductOfferRequestV1AllOfDelivery Class Doc Comment
 *
 * @category Class
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 ...
 */
class SaleProductOfferRequestV1AllOfDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleProductOfferRequestV1_allOf_delivery';
    ...
    */
    ...
    public function setAdditionalInfo($additional_info)
    {
        ...
        if ((mb_strlen($additional_info) > 650)) {
            throw new \InvalidArgumentException('invalid length for $additional_info when calling SaleProductOfferRequestV1AllOfDelivery., must be smaller than or equal to 650.');
        }
