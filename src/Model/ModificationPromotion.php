...
class ModificationPromotion implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets bold
     *
     * @param bool|null $bold Set the package `promoPackage` using the dedicated <a href=\"#operation/promoModificationCommandUsingPUT\">promotion modification resource</a>, instead.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $department_page Set the extra package `departmentPage` using the dedicated <a href=\"#operation/promoModificationCommandUsingPUT\">promotion modification resource</a>, instead.
     *
     * @return self
     */
     ...
     * Sets emphasized
     *
     * @param bool|null $emphasized Set the package `emphasized10d` using the dedicated <a href=\"#operation/promoModificationCommandUsingPUT\">promotion modification resource</a>, instead.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $emphasized_highlight_bold_package Set the package `promoPackage` using the dedicated <a href=\"#operation/promoModificationCommandUsingPUT\">promotion modification resource</a>, instead.
     *
     * @return self
     */
     ...
     * Sets highlight
     *
     * @param bool|null $highlight Set the package `promoPackage` using the dedicated <a href=\"#operation/promoModificationCommandUsingPUT\">promotion modification resource</a>, instead.
     *
     * @return self
     */
