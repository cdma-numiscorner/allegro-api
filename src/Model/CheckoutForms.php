...
class CheckoutForms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('checkout_forms', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($checkout_forms)) {
            throw new \InvalidArgumentException('non-nullable checkout_forms cannot be null');
        }
