...
class IntegerCategoryProductParameterAllOfRestrictions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets min
     *
     * @param int|null $min The minimum value of this parameter. Lower than or equal to `max`.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param int|null $max The maximum value of this parameter. Greater than or equal to `min`.
     *
     * @return self
     */
