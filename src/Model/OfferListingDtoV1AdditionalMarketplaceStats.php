...
/**
 * OfferListingDtoV1AdditionalMarketplaceStats Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferListingDtoV1AdditionalMarketplaceStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferListingDtoV1AdditionalMarketplace_stats';
    ...
    */
    ...
    public function setWatchersCount($watchers_count)
    {
        ...
        if (($watchers_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $watchers_count when calling OfferListingDtoV1AdditionalMarketplaceStats., must be bigger than or equal to 0.');
        }
    ...
    public function setVisitsCount($visits_count)
    {
        ...
        if (($visits_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $visits_count when calling OfferListingDtoV1AdditionalMarketplaceStats., must be bigger than or equal to 0.');
        }
