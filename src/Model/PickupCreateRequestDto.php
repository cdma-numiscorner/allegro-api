 ...
 */
class PickupCreateRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PickupCreateRequestDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['pickup_date_proposal_id'] = $data['pickup_date_proposal_id'] ?? null;
    }
    ...
    public function setShipmentIds($shipment_ids)
    {
        ...
        if ((count($shipment_ids) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $shipment_ids when calling PickupCreateRequestDto., number of items must be less than or equal to 2147483647.');
        }
        if ((count($shipment_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_ids when calling PickupCreateRequestDto., number of items must be greater than or equal to 1.');
        }
