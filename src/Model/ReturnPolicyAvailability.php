...
class ReturnPolicyAvailability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('restriction_cause', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($restriction_cause)) {
            throw new \InvalidArgumentException('non-nullable restriction_cause cannot be null');
        }
