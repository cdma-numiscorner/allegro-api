...
class CheckoutFormsOrderInvoices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'invoices' => '\AllegroApi\Model\CheckoutFormsOrderInvoice[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('has_external_invoices', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets invoices
     *
     * @return \AllegroApi\Model\CheckoutFormsOrderInvoice[]|null
     */
     ...
     * Sets invoices
     *
     * @param \AllegroApi\Model\CheckoutFormsOrderInvoice[]|null $invoices invoices
     *
     * @return self
     */
    ...
    {
        if (is_null($has_external_invoices)) {
            throw new \InvalidArgumentException('non-nullable has_external_invoices cannot be null');
        }
