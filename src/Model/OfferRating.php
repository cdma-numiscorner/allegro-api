...
class OfferRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'score_distribution' => '\AllegroApi\Model\OfferRatingScoreDistributionInner[]',
        'total_responses' => 'int',
        'size_feedback' => '\AllegroApi\Model\OfferRatingSizeFeedbackInner[]'
    ];
    ...
    {
        $this->setIfExists('average_score', $data ?? [], null);
        $this->setIfExists('score_distribution', $data ?? [], null);
        $this->setIfExists('total_responses', $data ?? [], null);
        $this->setIfExists('size_feedback', $data ?? [], null);
    }
    ...
    */
    ...
    public function setAverageScore($average_score)
    {
        if (is_null($average_score)) {
            throw new \InvalidArgumentException('non-nullable average_score cannot be null');
        }
     ...
     *
     * @return \AllegroApi\Model\OfferRatingScoreDistributionInner[]|null
     */
     ...
     *
     * @param \AllegroApi\Model\OfferRatingScoreDistributionInner[]|null $score_distribution List score distribution with count.
     *
     * @return self
     */
    public function setScoreDistribution($score_distribution)
    {
        if (is_null($score_distribution)) {
            throw new \InvalidArgumentException('non-nullable score_distribution cannot be null');
        }
    ...
    {
        if (is_null($total_responses)) {
            throw new \InvalidArgumentException('non-nullable total_responses cannot be null');
        }
     ...
     * Gets size_feedback
     *
     * @return \AllegroApi\Model\OfferRatingSizeFeedbackInner[]|null
     */
     ...
     * Sets size_feedback
     *
     * @param \AllegroApi\Model\OfferRatingSizeFeedbackInner[]|null $size_feedback List of size feedback.
     *
     * @return self
     */
    public function setSizeFeedback($size_feedback)
    {
        if (is_null($size_feedback)) {
            throw new \InvalidArgumentException('non-nullable size_feedback cannot be null');
        }
