...
class Payments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const INVOICE_VAT = 'VAT';
    public const INVOICE_VAT_MARGIN = 'VAT_MARGIN';
    public const INVOICE_WITHOUT_VAT = 'WITHOUT_VAT';
    public const INVOICE_NO_INVOICE = 'NO_INVOICE';
    ...
    */
    ...
    public function setInvoice($invoice)
    {
        ...
        $allowedValues = $this->getInvoiceAllowableValues();
        if (!in_array($invoice, $allowedValues, true)) {
