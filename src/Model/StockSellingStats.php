...
class StockSellingStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'last_week_average' => false,
		'last_thirty_days_sum' => false
    ];
    ...
    {
        $this->setIfExists('last_week_average', $data ?? [], null);
        $this->setIfExists('last_thirty_days_sum', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($last_week_average)) {
            throw new \InvalidArgumentException('non-nullable last_week_average cannot be null');
        }
    ...
    {
        if (is_null($last_thirty_days_sum)) {
            throw new \InvalidArgumentException('non-nullable last_thirty_days_sum cannot be null');
        }
