...
class CategoryParameterDisplayConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \AllegroApi\Model\CategoryParameterWithValue[] $parameters_with_value Condition type which displays this parameter only if the given other parameter has filled in one of the given value ids in an offer or product. Empty if no condition of this type is present.
     *
     * @return self
     */
     ...
     *
     * @param \AllegroApi\Model\CategoryParameterWithoutValue[] $parameters_without_value Condition type which displays this parameter only if the given other parameter has filled in neither a value nor a value id in an offer or product. Empty if no condition of this type is present.
     *
     * @return self
     */
