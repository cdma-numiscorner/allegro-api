...
/**
 * SaleProductOffersRequestStock Class Doc Comment
 *
 * @category Class
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 ...
 */
class SaleProductOffersRequestStock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleProductOffersRequestStock';
    ...
    */
    ...
    public function setAvailable($available)
    {
        ...
        if (($available < 0)) {
            throw new \InvalidArgumentException('invalid value for $available when calling SaleProductOffersRequestStock., must be bigger than or equal to 0.');
        }
