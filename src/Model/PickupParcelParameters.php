...
class PickupParcelParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'parcel_ids' => 'string[]',
        'pickup_date' => '\AllegroApi\Model\PickupDateProposal'
    ];
    ...
    {
        $this->setIfExists('parcel_ids', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($parcel_ids)) {
            throw new \InvalidArgumentException('non-nullable parcel_ids cannot be null');
        }
     ...
     * Gets pickup_date
     *
     * @return \AllegroApi\Model\PickupDateProposal|null
     */
     ...
     * Sets pickup_date
     *
     * @param \AllegroApi\Model\PickupDateProposal|null $pickup_date pickup_date
     *
     * @return self
     */
