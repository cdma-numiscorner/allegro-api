...
class WrapperTypeForPreviewConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'offer' => '\AllegroApi\Model\ParametersForPreviewPrice'
    ];
    ...
    {
        $this->setIfExists('include_quoting_bundles', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($include_quoting_bundles)) {
            throw new \InvalidArgumentException('non-nullable include_quoting_bundles cannot be null');
        }
     ...
     * Gets offer
     *
     * @return \AllegroApi\Model\ParametersForPreviewPrice|null
     */
     ...
     * Sets offer
     *
     * @param \AllegroApi\Model\ParametersForPreviewPrice|null $offer offer
     *
     * @return self
     */
