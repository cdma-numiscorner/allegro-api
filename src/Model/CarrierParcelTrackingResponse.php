...
class CarrierParcelTrackingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'carrier_id' => 'string',
        'waybills' => '\AllegroApi\Model\ParcelTrackingHistory[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('waybills', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets waybills
     *
     * @return \AllegroApi\Model\ParcelTrackingHistory[]
     */
     ...
     * Sets waybills
     *
     * @param \AllegroApi\Model\ParcelTrackingHistory[] $waybills Allegro parcel tracking history for multiple tracking numbers (waybills).
     *
     * @return self
     */
    ...
    {
        if (is_null($waybills)) {
            throw new \InvalidArgumentException('non-nullable waybills cannot be null');
        }
