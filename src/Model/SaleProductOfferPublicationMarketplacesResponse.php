...
class SaleProductOfferPublicationMarketplacesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets base
     *
     * @param JustId|null $base <small>[read-only]</small> Specifies the offer’s base service. We assign the value in the field automatically when the offer is created and it is read-only, it will never change.
     *
     * @return self
     */
