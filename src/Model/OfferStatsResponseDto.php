...
class OfferStatsResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'offer_stats' => '\AllegroApi\Model\OfferStatResponseDto[]'
    ];
    ...
    {
        $this->setIfExists('offer_stats', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets offer_stats
     *
     * @return \AllegroApi\Model\OfferStatResponseDto[]|null
     */
     ...
     * Sets offer_stats
     *
     * @param \AllegroApi\Model\OfferStatResponseDto[]|null $offer_stats offer_stats
     *
     * @return self
     */
    public function setOfferStats($offer_stats)
    {
        if (is_null($offer_stats)) {
            throw new \InvalidArgumentException('non-nullable offer_stats cannot be null');
        }
