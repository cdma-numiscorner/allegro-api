...
class Tax implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets percentage
     *
     * @param string|null $percentage The buy now tax rate, Format 0.00. The tax is linked to the default country that corresponds to the base marketplace of this offer.
     *
     * @return self
     */
