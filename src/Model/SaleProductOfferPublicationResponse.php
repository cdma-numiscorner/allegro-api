 ...
 */
class SaleProductOfferPublicationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleProductOfferPublicationResponse';
