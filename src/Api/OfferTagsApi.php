...
/**
     ...
     * @return void
     */
    public function assignTagToOfferPOST($offer_id, $tag_ids_request, string $contentType = self::contentTypes['assignTagToOfferPOST'][0])
    {
        $this->assignTagToOfferPOSTWithHttpInfo($offer_id, $tag_ids_request, $contentType);
    }
     ...
     */
    public function assignTagToOfferPOSTWithHttpInfo($offer_id, $tag_ids_request, string $contentType = self::contentTypes['assignTagToOfferPOST'][0])
    {
        $request = $this->assignTagToOfferPOSTRequest($offer_id, $tag_ids_request, $contentType);
     ...
     */
    public function assignTagToOfferPOSTAsync($offer_id, $tag_ids_request, string $contentType = self::contentTypes['assignTagToOfferPOST'][0])
    {
        return $this->assignTagToOfferPOSTAsyncWithHttpInfo($offer_id, $tag_ids_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function assignTagToOfferPOSTAsyncWithHttpInfo($offer_id, $tag_ids_request, string $contentType = self::contentTypes['assignTagToOfferPOST'][0])
    {
        $returnType = '';
        $request = $this->assignTagToOfferPOSTRequest($offer_id, $tag_ids_request, $contentType);
     ...
     */
    public function assignTagToOfferPOSTRequest($offer_id, $tag_ids_request, string $contentType = self::contentTypes['assignTagToOfferPOST'][0])
    {
        ...
        if (isset($tag_ids_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($tag_ids_request));
            } else {
    ...
    {
        list($response) = $this->createTagPOST1WithHttpInfo($tag_request, $contentType);
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\TagId' === '\SplFileObject') {
                        ...
                        if ('\AllegroApi\Model\TagId' !== 'string') {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTagPOST1Async($tag_request, string $contentType = self::contentTypes['createTagPOST1'][0])
    {
        return $this->createTagPOST1AsyncWithHttpInfo($tag_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createTagPOST1Request($tag_request, string $contentType = self::contentTypes['createTagPOST1'][0])
    {
    ...
    {
        list($response) = $this->listAssignedOfferTagsGETWithHttpInfo($offer_id, $contentType);
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\TagListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\AllegroApi\Model\TagListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAssignedOfferTagsGETAsync($offer_id, string $contentType = self::contentTypes['listAssignedOfferTagsGET'][0])
    {
        return $this->listAssignedOfferTagsGETAsyncWithHttpInfo($offer_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listAssignedOfferTagsGETRequest($offer_id, string $contentType = self::contentTypes['listAssignedOfferTagsGET'][0])
    {
    ...
    {
        list($response) = $this->listSellerTagsGET1WithHttpInfo($limit, $offset, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSellerTagsGET1Async($limit = 1000, $offset = 0, string $contentType = self::contentTypes['listSellerTagsGET1'][0])
    {
        return $this->listSellerTagsGET1AsyncWithHttpInfo($limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listSellerTagsGET1Request($limit = 1000, $offset = 0, string $contentType = self::contentTypes['listSellerTagsGET1'][0])
    {
     ...
     * @return void
     */
    public function updateTagPUT($tag_id, $tag_request, string $contentType = self::contentTypes['updateTagPUT'][0])
    {
        $this->updateTagPUTWithHttpInfo($tag_id, $tag_request, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTagPUTWithHttpInfo($tag_id, $tag_request, string $contentType = self::contentTypes['updateTagPUT'][0])
    {
        $request = $this->updateTagPUTRequest($tag_id, $tag_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTagPUTAsync($tag_id, $tag_request, string $contentType = self::contentTypes['updateTagPUT'][0])
    {
        return $this->updateTagPUTAsyncWithHttpInfo($tag_id, $tag_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTagPUTAsyncWithHttpInfo($tag_id, $tag_request, string $contentType = self::contentTypes['updateTagPUT'][0])
    {
        $returnType = '';
        $request = $this->updateTagPUTRequest($tag_id, $tag_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTagPUTRequest($tag_id, $tag_request, string $contentType = self::contentTypes['updateTagPUT'][0])
    {
