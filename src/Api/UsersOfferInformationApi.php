...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOfferEvents'] to see the possible values for this operation
     *
     ...
     */
    public function getOfferEvents($from = null, $limit = 100, $type = null, string $contentType = self::contentTypes['getOfferEvents'][0])
    {
        list($response) = $this->getOfferEventsWithHttpInfo($from, $limit, $type, $contentType);
        return $response;
    }
     ...
     */
    public function getOfferEventsWithHttpInfo($from = null, $limit = 100, $type = null, string $contentType = self::contentTypes['getOfferEvents'][0])
    {
        $request = $this->getOfferEventsRequest($from, $limit, $type, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\SellerOfferEventsResponse' === '\SplFileObject') {
                        ...
                        if ('\AllegroApi\Model\SellerOfferEventsResponse' !== 'string') {
     ...
     */
    public function getOfferEventsAsync($from = null, $limit = 100, $type = null, string $contentType = self::contentTypes['getOfferEvents'][0])
    {
        return $this->getOfferEventsAsyncWithHttpInfo($from, $limit, $type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOfferEventsAsyncWithHttpInfo($from = null, $limit = 100, $type = null, string $contentType = self::contentTypes['getOfferEvents'][0])
    {
        $returnType = '\AllegroApi\Model\SellerOfferEventsResponse';
        $request = $this->getOfferEventsRequest($from, $limit, $type, $contentType);
     ...
     */
    public function getOfferEventsRequest($from = null, $limit = 100, $type = null, string $contentType = self::contentTypes['getOfferEvents'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOfferSmartClassificationGET'] to see the possible values for this operation
     *
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getOfferSmartClassificationGET($offer_id, $marketplace_id = null, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        list($response) = $this->getOfferSmartClassificationGETWithHttpInfo($offer_id, $marketplace_id, $contentType);
        return $response;
    }
     ...
     */
    public function getOfferSmartClassificationGETWithHttpInfo($offer_id, $marketplace_id = null, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        $request = $this->getOfferSmartClassificationGETRequest($offer_id, $marketplace_id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\SmartOfferClassificationReport' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\AllegroApi\Model\SmartOfferClassificationReport' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOfferSmartClassificationGETAsync($offer_id, $marketplace_id = null, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        return $this->getOfferSmartClassificationGETAsyncWithHttpInfo($offer_id, $marketplace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOfferSmartClassificationGETAsyncWithHttpInfo($offer_id, $marketplace_id = null, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        $returnType = '\AllegroApi\Model\SmartOfferClassificationReport';
        $request = $this->getOfferSmartClassificationGETRequest($offer_id, $marketplace_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOfferSmartClassificationGETRequest($offer_id, $marketplace_id = null, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchOffersUsingGET'] to see the possible values for this operation
     *
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\OffersSearchResultDto' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\AllegroApi\Model\OffersSearchResultDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
    ...
    public function searchOffersUsingGETRequest($offer_id = null, $name = null, $selling_mode_price_amount_gte = null, $selling_mode_price_amount_lte = null, $publication_status = null, $publication_marketplace = null, $selling_mode_format = null, $external_id = null, $delivery_shipping_rates_id = null, $delivery_shipping_rates_id_empty = null, $sort = null, $limit = 20, $offset = null, $category_id = null, $product_id_empty = null, $productization_required = null, $b2b_buyable_only_by_business = null, $fundraising_campaign_id = null, $fundraising_campaign_id_empty = null, string $contentType = self::contentTypes['searchOffersUsingGET'][0])
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $selling_mode_price_amount_gte,
            'sellingMode.price.amount.gte', // param base name
            'number', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $selling_mode_price_amount_lte,
            'sellingMode.price.amount.lte', // param base name
            'number', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $selling_mode_format,
            'sellingMode.format', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $delivery_shipping_rates_id,
            'delivery.shippingRates.id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $delivery_shipping_rates_id_empty,
            'delivery.shippingRates.id.empty', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $product_id_empty,
            'product.id.empty', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $productization_required,
            'productizationRequired', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $b2b_buyable_only_by_business,
            'b2b.buyableOnlyByBusiness', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'fundraisingCampaign.id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $fundraising_campaign_id_empty,
            'fundraisingCampaign.id.empty', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
