...
/**
    ...
    {
        list($response) = $this->getFulfillmentOrderParcelsWithHttpInfo($order_id, $contentType);
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\FulfillmentOrder' === '\SplFileObject') {
                        ...
                        if ('\AllegroApi\Model\FulfillmentOrder' !== 'string') {
     ...
     */
    public function getFulfillmentOrderParcelsAsync($order_id, string $contentType = self::contentTypes['getFulfillmentOrderParcels'][0])
    {
        return $this->getFulfillmentOrderParcelsAsyncWithHttpInfo($order_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getFulfillmentOrderParcelsRequest($order_id, string $contentType = self::contentTypes['getFulfillmentOrderParcels'][0])
    {
