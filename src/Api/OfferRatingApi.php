...
/**
    ...
    {
        list($response) = $this->offerRatingGETWithHttpInfo($offer_id, $contentType);
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\OfferRating' === '\SplFileObject') {
                        ...
                        if ('\AllegroApi\Model\OfferRating' !== 'string') {
     ...
     */
    public function offerRatingGETAsync($offer_id, string $contentType = self::contentTypes['offerRatingGET'][0])
    {
        return $this->offerRatingGETAsyncWithHttpInfo($offer_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function offerRatingGETRequest($offer_id, string $contentType = self::contentTypes['offerRatingGET'][0])
    {
